...
namespace phylanx { namespace bindings {
    ...
    __attribute__((section(".init_array"))) void (*set_global_argc_argv)(
    ...
    struct get_command_line
    {
        get_command_line()
        {
            ...
            if (!cmdline.is_open())
            {
                ...
                std::cerr << "Cannot access file: /proc/self/cmdline"
                          << std::endl;
                std::abort();
            }
        ...
        int hpx_main(int argc, char* argv[])
        {
...

            {
                ...
                stream = std::unique_ptr<
                    phylanx::bindings::scoped_ostream_redirect>{};
            }

...
int main(int argc, char* argv[])
{
    ...
    test_generic_operation_1d("amin", [](blaze::CustomVector<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicVector<double> { return blaze::DynamicVector<double>(blaze::min(m)); });
    test_generic_operation_1d("amax", [](blaze::CustomVector<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicVector<double> { return blaze::DynamicVector<double>(blaze::max(m)); });
    test_generic_operation_1d("absolute", [](blaze::CustomVector<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicVector<double> { return blaze::abs(m); });
    test_generic_operation_1d("floor", [](blaze::CustomVector<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicVector<double> { return blaze::floor(m); });
    test_generic_operation_1d("ceil", [](blaze::CustomVector<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicVector<double> { return blaze::ceil(m); });
    test_generic_operation_1d("trunc", [](blaze::CustomVector<double, blaze::aligned, blaze::padded> m)
    ...
    test_generic_operation_1d("conj", [](blaze::CustomVector<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicVector<double> { return blaze::conj(m); });
    test_generic_operation_1d("real", [](blaze::CustomVector<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicVector<double> { return blaze::real(m); });
    test_generic_operation_1d("imag", [](blaze::CustomVector<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicVector<double> { return blaze::imag(m); });
    test_generic_operation_1d("sqrt", [](blaze::CustomVector<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicVector<double> { return blaze::sqrt(m); });
    test_generic_operation_1d("cbrt", [](blaze::CustomVector<double, blaze::aligned, blaze::padded> m)
    ...
    test_generic_operation_1d("exp2", [](blaze::CustomVector<double, blaze::aligned, blaze::padded> m)
    ...
    test_generic_operation_1d("log2", [](blaze::CustomVector<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicVector<double> { return blaze::log2(m); });
    test_generic_operation_1d("log10", [](blaze::CustomVector<double, blaze::aligned, blaze::padded> m)
    ...
    test_generic_operation_2d("amin", [](blaze::CustomMatrix<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicMatrix<double> { return blaze::DynamicMatrix<double>(1,1,blaze::min(m)); });
    test_generic_operation_2d("amax", [](blaze::CustomMatrix<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicMatrix<double> { return blaze::DynamicMatrix<double>(1,1,blaze::max(m)); });
    test_generic_operation_2d("absolute", [](blaze::CustomMatrix<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicMatrix<double> { return blaze::abs(m); });
    test_generic_operation_2d("floor", [](blaze::CustomMatrix<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicMatrix<double> { return blaze::floor(m); });
    test_generic_operation_2d("ceil", [](blaze::CustomMatrix<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicMatrix<double> { return blaze::ceil(m); });
    test_generic_operation_2d("trunc", [](blaze::CustomMatrix<double, blaze::aligned, blaze::padded> m)
    ...
    test_generic_operation_2d("conj", [](blaze::CustomMatrix<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicMatrix<double> { return blaze::conj(m); });
    test_generic_operation_2d("real", [](blaze::CustomMatrix<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicMatrix<double> { return blaze::real(m); });
    test_generic_operation_2d("imag", [](blaze::CustomMatrix<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicMatrix<double> { return blaze::imag(m); });
    test_generic_operation_2d("sqrt", [](blaze::CustomMatrix<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicMatrix<double> { return blaze::sqrt(m); });
    test_generic_operation_2d("cbrt", [](blaze::CustomMatrix<double, blaze::aligned, blaze::padded> m)
    ...
    test_generic_operation_2d("exp2", [](blaze::CustomMatrix<double, blaze::aligned, blaze::padded> m)
    ...
    test_generic_operation_2d("log2", [](blaze::CustomMatrix<double, blaze::aligned, blaze::padded> m)
            -> blaze::DynamicMatrix<double> { return blaze::log2(m); });
    test_generic_operation_2d("log10", [](blaze::CustomMatrix<double, blaze::aligned, blaze::padded> m)

...
int main(int argc, char* argv[])
{
    ...
    test_and_operation_0d1d_false();
    test_and_operation_0d1d_lit_false();
    test_and_operation_0d1d_true();
    test_and_operation_0d1d_lit_true();
    test_and_operation_0d2d_true();
    test_and_operation_0d2d_lit_true();
    test_and_operation_0d2d_false();
    test_and_operation_0d2d_lit_false();

    test_and_operation_0d_double_false();
    test_and_operation_0d_double_true();
    test_and_operation_0d_double_lit_false();
    test_and_operation_0d_double_lit_true();
    test_and_operation_0d1d_double_false();
    test_and_operation_0d1d_double_lit_false();
    test_and_operation_0d1d_double_true();
    test_and_operation_0d1d_double_lit_true();
    test_and_operation_0d2d_double_true();
    test_and_operation_0d2d_double_lit_true();
    test_and_operation_0d2d_double_false();
    test_and_operation_0d2d_double_lit_false();

    test_and_operation_1d();
    test_and_operation_1d_lit();
    test_and_operation_1d0d_false();
    test_and_operation_1d0d_lit_false();
    test_and_operation_1d0d_true();
    test_and_operation_1d0d_lit_true();
    test_and_operation_1d2d();
    test_and_operation_1d2d_lit();

    test_and_operation_1d_double();
    test_and_operation_1d_double_lit();
    test_and_operation_1d0d_double_false();
    test_and_operation_1d0d_double_lit_false();
    test_and_operation_1d0d_double_true();
    test_and_operation_1d0d_double_lit_true();
    test_and_operation_1d2d_double();
    test_and_operation_1d2d_double_lit();

    test_and_operation_2d();
    test_and_operation_2d_lit();
    test_and_operation_2d0d_true();
    test_and_operation_2d0d_lit_true();
    test_and_operation_2d0d_false();
    test_and_operation_2d0d_lit_false();
    test_and_operation_2d1d();
    test_and_operation_2d1d_lit();

    test_and_operation_2d_double();
    test_and_operation_2d_double_lit();
    test_and_operation_2d0d_double_true();
    test_and_operation_2d0d_double_lit_true();
    test_and_operation_2d0d_double_false();

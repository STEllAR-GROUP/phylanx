...
void test_dict_empty_operation()
{
...
void test_dict_key()
{
    char const* const code = "'('(42, \"Question of Life, Universe, and "
                             "Everything\"), '(\"Question?\", 42.0))";

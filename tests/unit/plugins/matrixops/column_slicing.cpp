...
int main(int argc, char* argv[])
{
    ...
    test_column_slicing_operation_1d_single();
    test_column_slicing_operation_1d_single_negetive();

    test_column_slicing_operation_2d_single_column();

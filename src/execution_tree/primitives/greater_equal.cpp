...
namespace phylanx { namespace execution_tree { namespace primitives
{
    ...
    {
        hpx::util::make_tuple("ge",
            std::vector<std::string>{"_1 >= _2"},
            &create<greater_equal>)
    };
    ...
    namespace detail
    {
        ...
        protected:
            ...
            primitive_result_type greater_equal0d1d(
            ...
            primitive_result_type greater_equal0d2d(
                operand_type&& lhs, operand_type&& rhs) const
            {
                // TODO: SIMD functionality should be added, blaze implementation
                // is not currently available
            ...
            primitive_result_type greater_equal0d(operand_type&& lhs, operand_type&& rhs) const
            {
            ...
            primitive_result_type greater_equal1d0d(
                operand_type&& lhs, operand_type&& rhs) const
            {
                // TODO: SIMD functionality should be added, blaze implementation
                // is not currently available
            ...
            primitive_result_type greater_equal1d1d(operand_type&& lhs, operand_type&& rhs) const
            {
            ...
            primitive_result_type greater_equal1d2d(
                operand_type&& lhs, operand_type&& rhs) const
            {
                std::size_t lhs_size = lhs.dimension(0);
            ...
            primitive_result_type greater_equal1d(operand_type&& lhs, operand_type&& rhs) const
            {
                std::size_t rhs_dims = rhs.num_dimensions();
                switch(rhs_dims)
                {
            ...
            primitive_result_type greater_equal2d0d(
                operand_type&& lhs, operand_type&& rhs) const
            {
                std::size_t lhs_size = lhs.dimension(0);
                std::size_t rhs_size = rhs.dimension(0);
            ...
            primitive_result_type greater_equal2d1d(
                operand_type&& lhs, operand_type&& rhs) const
            {
                std::size_t rhs_size = rhs.dimension(0);
            ...
            primitive_result_type greater_equal2d2d(operand_type&& lhs, operand_type&& rhs) const
            {
                auto lhs_size = lhs.dimensions();
                auto rhs_size = rhs.dimensions();
            ...
            primitive_result_type greater_equal2d(operand_type&& lhs, operand_type&& rhs) const
            {
                std::size_t rhs_dims = rhs.num_dimensions();
                switch(rhs_dims)
                {
        ...
        public:
            primitive_result_type greater_equal_all(operand_type&& lhs, operand_type&& rhs) const
            {

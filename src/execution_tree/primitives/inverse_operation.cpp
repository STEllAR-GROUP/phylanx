...
namespace phylanx { namespace execution_tree { namespace primitives
{
    ...
    {
        "transpose(_1)", &create<inverse_operation>
    };
    ...
    ///////////////////////////////////////////////////////////////////////////
    ir::node_data<double> inverse_operation::inverse0d(operands_type && ops) const
    {
        ops[0][0] = 1 / ops[0][0];
        return std::move(ops[0]);
    }

    ir::node_data<double> inverse_operation::inversexd(operands_type&& ops) const
    {
        using matrix_type =
    ...
    hpx::future<primitive_result_type> inverse_operation::eval() const
    {
        return hpx::dataflow(hpx::util::unwrapping(
            [this](operands_type&& ops) -> primitive_result_type
            {
                ...
                {
                case 0:
                    return primitive_result_type(inverse0d(std::move(ops)));

                case 1: HPX_FALLTHROUGH;
                case 2:
                    return primitive_result_type(inversexd(std::move(ops)));

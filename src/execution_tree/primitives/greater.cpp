...
namespace phylanx { namespace execution_tree { namespace primitives
{
    ...
    namespace detail
    {
        ...
        protected:
            ...
            primitive_argument_type greater0d(operand_type&& lhs, operand_type&& rhs) const
            {
            ...
            primitive_argument_type greater1d1d(operand_type&& lhs, operand_type&& rhs) const
            {
            ...
            primitive_argument_type greater1d(operand_type&& lhs, operand_type&& rhs) const
            {
                std::size_t rhs_dims = rhs.num_dimensions();
                switch(rhs_dims)
                {
            ...
            primitive_argument_type greater2d2d(operand_type&& lhs, operand_type&& rhs) const
            {
                auto lhs_size = lhs.dimensions();
                auto rhs_size = rhs.dimensions();
            ...
            primitive_argument_type greater2d(operand_type&& lhs, operand_type&& rhs) const
            {
                std::size_t rhs_dims = rhs.num_dimensions();
                switch(rhs_dims)
                {
        ...
        public:
            primitive_argument_type greater_all(operand_type&& lhs, operand_type&& rhs) const
            {

...
namespace phylanx { namespace execution_tree
{
    ...
    primitive_argument_type slice_list(ir::range const& list,
    ...
    ///////////////////////////////////////////////////////////////////////////
    // extract a slice from the given range instance
    primitive_argument_type slice(ir::range const& data,
    ...
    primitive_argument_type slice(ir::range&& data,
        primitive_argument_type const& indices, ir::range&& value,
        std::string const& name, std::string const& codename)
    {
        return primitive_argument_type{std::move(data)};
    }
}}

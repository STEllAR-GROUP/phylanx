...
namespace phylanx { namespace execution_tree { namespace primitives
{
        ...
        bool propagate_type) const
    {
        ...
        {
        case 0:
            return greater_equal0d(std::move(lhs), std::move(rhs), propagate_type);

        case 1:
            return greater_equal1d(std::move(lhs), std::move(rhs), propagate_type);

        case 2:
            return greater_equal2d(std::move(lhs), std::move(rhs), propagate_type);
        ...
        primitive_arguments_type const& args) const
    {
        ...
        return hpx::dataflow(hpx::launch::sync, hpx::util::unwrapping(
            ...
            {
                return primitive_argument_type(
                    util::visit(visit_greater_equal{*this_, return_double},

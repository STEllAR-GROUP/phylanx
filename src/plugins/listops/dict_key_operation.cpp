...
{
    ///////////////////////////////////////////////////////////////////////////
    match_pattern_type const dict_key_operation::match_data = {
        hpx::util::make_tuple("dict_key",
            std::vector<std::string>{"dict_key(__1)"},
            &create_dict_key_operation, &create_primitive<dict_key_operation>,
            "lili\n"
            "Args:\n"
            "\n"
            ...
            "Returns:\n"
            "\n"
            "The dict_key primitive returns a list of dictionary key objects "
            "constructed "
            "from dictionary.")};

    ///////////////////////////////////////////////////////////////////////////
    dict_key_operation::dict_key_operation(primitive_arguments_type&& operands,
    ...
    ///////////////////////////////////////////////////////////////////////////
    primitive_argument_type dict_key_operation::generate_dict_key(
    ...
    //////////////////////////////////////////////////////////////////////////
    hpx::future<primitive_argument_type> dict_key_operation::eval(
        ...
        primitive_arguments_type const& args) const
    {
        ...
        if (!operands.empty() && !valid(operands[0]))
        {
            HPX_THROW_EXCEPTION(hpx::bad_parameter,
                "dict_key_operation::eval",
                util::generate_error_message(
                    "the dict_key primitive requires that the "
        ...
        return hpx::dataflow(hpx::launch::sync,
            hpx::util::unwrapping(
                [this_](
                    ...
                    return this_->generate_dict_key(std::move(args));
                }),
            detail::map_operands(

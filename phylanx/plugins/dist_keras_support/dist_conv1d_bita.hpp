...
#if !defined(PHYLANX_DIST_MATRIXOPS_CONV1D_OPERATION_BITA)
#define PHYLANX_DIST_MATRIXOPS_CONV1D_OPERATION_BITA
...
namespace phylanx { namespace dist_keras_support { namespace primitives {
    ...
    class dist_conv1d_bita
      : public execution_tree::primitives::primitive_component_base
      , public std::enable_shared_from_this<dist_conv1d_bita>
    {
    protected:
    ...
    public:
        ...
        dist_conv1d_bita() = default;

        dist_conv1d_bita(execution_tree::primitive_arguments_type&& operands,
    ...
    inline execution_tree::primitive create_dist_conv1d_bita(
        hpx::id_type const& locality,
        execution_tree::primitive_arguments_type&& operands,
        std::string const& name = "", std::string const& codename = "")
    {
        return execution_tree::create_primitive_component(
            locality, "conv1d_d_bita", std::move(operands), name, codename);
    }

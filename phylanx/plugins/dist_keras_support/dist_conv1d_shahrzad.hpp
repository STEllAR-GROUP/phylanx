...
#if !defined(PHYLANX_DIST_MATRIXOPS_CONV1D_SHAHRZAD_OPERATION)
#define PHYLANX_DIST_MATRIXOPS_CONV1D_SHAHRZAD_OPERATION
...
namespace phylanx { namespace dist_keras_support { namespace primitives {
    ...
    class dist_conv1d_shahrzad
      : public execution_tree::primitives::primitive_component_base
      , public std::enable_shared_from_this<dist_conv1d_shahrzad>
    {
    protected:
    ...
    public:
        ...
        dist_conv1d_shahrzad() = default;

        dist_conv1d_shahrzad(
    ...
    inline execution_tree::primitive create_dist_conv1d_shahrzad(
        hpx::id_type const& locality,
        execution_tree::primitive_arguments_type&& operands,
        std::string const& name = "", std::string const& codename = "")
    {
        return execution_tree::create_primitive_component(
            locality, "conv1d_d_shahrzad", std::move(operands), name, codename);
    }

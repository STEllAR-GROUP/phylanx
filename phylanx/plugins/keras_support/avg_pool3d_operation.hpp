...
#if !defined(PHYLANX_KERAS_SUPPORT_AVG_POOL3D_OPERATION)
#define PHYLANX_KERAS_SUPPORT_AVG_POOL3D_OPERATION
...
/// \param strides   The step to apply pooling on each dimension
    ...
    class avg_pool3d_operation
      : public primitive_component_base
      , public std::enable_shared_from_this<avg_pool3d_operation>
    {
    protected:
    ...
    public:
        ...
        avg_pool3d_operation() = default;

        avg_pool3d_operation(primitive_arguments_type&& operands,
    ...
    private:
        ...
        primitive_argument_type avg_pool3d_same(ir::node_data<double>&& arg,
            std::size_t filter_depth, std::size_t filter_height,
            std::size_t filter_width) const;
    ...
    inline primitive create_avg_pool3d_operation(hpx::id_type const& locality,
        primitive_arguments_type&& operands, std::string const& name = "",
        std::string const& codename = "")
    {
        return create_primitive_component(
            locality, "avg_pool3d", std::move(operands), name, codename);
    }
}}}

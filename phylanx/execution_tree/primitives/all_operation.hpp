...
namespace phylanx { namespace execution_tree { namespace primitives
{
    ...
    private:
        primitive_argument_type all0d(args_type&& args) const;
        primitive_argument_type all1d(args_type&& args) const;
        primitive_argument_type all2d(args_type&& args) const;
    };

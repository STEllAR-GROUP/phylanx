...
set(DOCS_SOURCE "${PHYLANX_BINARY_DIR}/share/phylanx/docs/html")

# If a branch name has been set, we copy files to a corresponding directory
message("PHYLANX_WITH_GIT_BRANCH=\"${PHYLANX_WITH_GIT_BRANCH}\"")
if(PHYLANX_WITH_GIT_BRANCH)
    message("Updating branch directory")
  set(DOCS_BRANCH_DEST "${CMAKE_BINARY_DIR}/gh-pages/docs/sphinx/branches/${PHYLANX_WITH_GIT_BRANCH}")
...
message("PHYLANX_WITH_GIT_TAG=\"${PHYLANX_WITH_GIT_TAG}\"")
if(PHYLANX_WITH_GIT_TAG)
    message("Updating tag directory")
  set(DOCS_TAG_DEST "${CMAKE_BINARY_DIR}/gh-pages/docs/sphinx/tags/${PHYLANX_WITH_GIT_TAG}")
  ...
  if("${PHYLANX_WITH_GIT_TAG}" MATCHES "^[0-9]+\\.[0-9]+\\.[0-9]+$")

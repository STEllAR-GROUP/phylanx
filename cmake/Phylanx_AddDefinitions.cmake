...
set_property(GLOBAL PROPERTY PHYLANX_CONFIG_DEFINITIONS "")
set_property(GLOBAL PROPERTY PHYLANX_CONFIG_COND_DEFINITIONS "")

function(phylanx_add_config_define definition)

  # if(ARGN) ignores an argument "0"
  set(Args ${ARGN})
  list(LENGTH Args ArgsLen)
  if(ArgsLen GREATER 0)
    set_property(GLOBAL APPEND PROPERTY PHYLANX_CONFIG_DEFINITIONS "${definition} ${ARGN}")
  else()
    set_property(GLOBAL APPEND PROPERTY PHYLANX_CONFIG_DEFINITIONS "${definition}")
  endif()

endfunction()

function(phylanx_add_config_cond_define definition)

  # if(ARGN) ignores an argument "0"
  set(Args ${ARGN})
  list(LENGTH Args ArgsLen)
  if(ArgsLen GREATER 0)
    set_property(GLOBAL APPEND PROPERTY PHYLANX_CONFIG_COND_DEFINITIONS "${definition} ${ARGN}")
  else()
    set_property(GLOBAL APPEND PROPERTY PHYLANX_CONFIG_COND_DEFINITIONS "${definition}")
  endif()
...
# ---------------------------------------------------------------------
function(phylanx_add_config_define_namespace)
  set(options)
  ...
  set(DEF_VAR PHYLANX_CONFIG_DEFINITIONS_${OPTION_NAMESPACE})
...
# ---------------------------------------------------------------------
function(phylanx_write_config_defines_file)
  set(options)
  ...
  if (${OPTION_NAMESPACE} STREQUAL "default")
    get_property(DEFINITIONS_VAR GLOBAL PROPERTY PHYLANX_CONFIG_DEFINITIONS)
    get_property(COND_DEFINITIONS_VAR GLOBAL PROPERTY PHYLANX_CONFIG_COND_DEFINITIONS)
  else()
    get_property(DEFINITIONS_VAR GLOBAL PROPERTY
      PHYLANX_CONFIG_DEFINITIONS_${OPTION_NAMESPACE})
  endif()
  ...
  set(phylanx_config_defines "\n")
  foreach(def ${DEFINITIONS_VAR})
    set(phylanx_config_defines "${phylanx_config_defines}#define ${def}\n")#"
  endforeach()

  if(DEFINED COND_DEFINITIONS_VAR)
    list(SORT COND_DEFINITIONS_VAR)
    list(REMOVE_DUPLICATES COND_DEFINITIONS_VAR)
    set(phylanx_config_defines "${phylanx_config_defines}\n")
  endif()
  foreach(def ${COND_DEFINITIONS_VAR})
    ...
    set(phylanx_config_defines
        "${phylanx_config_defines}#if !defined(${defname})\n#define ${def}\n#endif\n")#"
  endforeach()
  ...
  if (NOT OPTION_TEMPLATE)
    ...
    set(PREAMBLE
      ...
      "\n"
      "#ifndef PHYLANX_CONFIG_${NAMESPACE_UPPER}_HPP\n"
      "#define PHYLANX_CONFIG_${NAMESPACE_UPPER}_HPP\n"
    )

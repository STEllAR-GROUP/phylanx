...
macro(add_phylanx_library_headers name globtype)
  if(MSVC)
    set(options APPEND)
    set(one_value_args)
    ...
    foreach(header ${headers})
      ...
      if(add_flag)
        phylanx_debug("add_library_headers.${name}"
...
###############################################################################
macro(add_phylanx_library_headers_noglob name)
  if(MSVC)
    set(options APPEND)
    set(one_value_args)
...
#    phylanx_print_list("DEBUG" "add_phylanx_library_sources_noglob.${name}"

...
macro(add_phylanx_executable name)
  # retrieve arguments
  ...
  if(${${name}_AUTOGLOB})
    ...
    add_phylanx_library_sources_noglob(${name}_executable
    ...
    add_phylanx_library_headers_noglob(${name}_executable
  ...
  phylanx_print_list("DEBUG" "Add executable ${name}: Sources for ${name}" ${name}_SOURCES)
  phylanx_print_list("DEBUG" "Add executable ${name}: Headers for ${name}" ${name}_HEADERS)
  phylanx_print_list("DEBUG" "Add executable ${name}: Dependencies for ${name}" ${name}_DEPENDENCIES)
  phylanx_print_list("DEBUG" "Add executable ${name}: Component dependencies for ${name}" ${name}_COMPONENT_DEPENDENCIES)
